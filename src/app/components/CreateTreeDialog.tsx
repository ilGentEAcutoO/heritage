...
const s = {
  ...
  label: { display: 'block', fontSize: '0.8rem', fontWeight: 600 as const, color: 'var(--ink-soft)', margin: '0.85rem 0 0.3rem' },
  input: {
    width: '100%',
  ...
  hint: { fontSize: '0.75rem', color: 'var(--ink-faint)', marginTop: '0.25rem' },
